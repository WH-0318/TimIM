...
public class MainActivity extends BaseLightActivity {
    ...
    private TabBean conferenceBean;
    ...
    private void initTabs() {
        ...
        // conference
        conferenceBean = new TabBean();
        conferenceBean.normalIcon = R.attr.demo_main_tab_community_normal_bg;
        conferenceBean.selectedIcon = R.attr.demo_main_tab_community_selected_bg;
        conferenceBean.text = R.string.tab_conference_tab_text;
        conferenceBean.fragment = new ConferenceHomeFragment();
        conferenceBean.weight = 90;
        tabBeanList.add(conferenceBean);
    ...
    private void setTabSelected(TabBean tabBean) {
        ...
        } else if (tabBean == conferenceBean) {
            setConferenceTitleBar();
    ...
    private void setConferenceTitleBar() {
        mainTitleBar.getLeftGroup().setVisibility(View.GONE);
        mainTitleBar.getRightGroup().setVisibility(View.GONE);
        mainTitleBar.setTitle(getResources().getString(R.string.tab_conference_tab_text), ITitleBarLayout.Position.MIDDLE);
    }
